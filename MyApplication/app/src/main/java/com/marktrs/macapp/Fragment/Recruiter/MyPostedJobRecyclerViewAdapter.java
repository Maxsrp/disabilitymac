...
import com.marktrs.macapp.Fragment.Recruiter.PostedJobFragment.OnListFragmentInteractionListener;
...
public class MyPostedJobRecyclerViewAdapter extends RecyclerView.Adapter<MyPostedJobRecyclerViewAdapter.ViewHolder> {
    ...
    public MyPostedJobRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
